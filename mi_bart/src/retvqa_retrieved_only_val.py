...
from retvqa_retrieved_data import get_loader
...
class Trainer(TrainerBase):
    ...
    def predict(self, loader, dump_path=None):
        ...
        with torch.no_grad():
            ...
            for i, batch in enumerate(tqdm(loader, ncols=120, desc="Prediction", disable=not self.verbose)):
                ...
                ques_ids.extend(batch['question_ids'])
            ...
            if self.args.distributed:
                ...
                for result in dist_results:
                    ...
                    ques_ids.extend(result['ques_ids'])
                ...
                for ques_id, ans in zip(results['ques_ids'], results['predictions']):
                    quesid2ans[ques_id] = ans
                ...
                json.dump(quesid2ans, open(dump_path.replace('.csv', '.json'), 'w'))
    ...
    def evaluate_with_best(self, loader, dump_path=None):

        # Test Set
        # best_path = os.path.join(self.args.output, 'BEST')
        best_path = '/data1/abhiram/webqa/VL-T5/VL-T5/snap/model_from10_6_0_40/BEST'
        self.load(best_path)
...
def main_worker(gpu, args):
    ...
    # trainer.train()
    trainer.evaluate_with_best(test_loader, dump_path = '/data1/abhiram/webqa/VL-T5/VL-T5/snap/retvqa/VLBart/test_results_retvqa_v4_paraphrased.json')
