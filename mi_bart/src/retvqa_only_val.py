...
class Trainer(TrainerBase):
    ...
    def evaluate_with_best(self, loader, dump_path=None):
        ...
        best_path = os.path.join(self.args.output, 'BEST')
        # self.load(best_path)
        self.load('/data1/abhiram/webqa/VL-T5/VL-T5/snap/model_from10_6_0_40/BEST')
...
def main_worker(gpu, args):
    ...
    # trainer.train()
    trainer.evaluate_with_best(test_loader, dump_path = '/data1/abhiram/webqa/VL-T5/VL-T5/snap/retvqa/VLBart/val_results_paraphrased_v4.csv')
